		...
		>
			...
			>
				<svg
					...
					fill="none"
					viewBox="0 0 220 32"
					style={{ height: 18, color: "var(--text)" }}
				>
					<path
						fill="currentColor"
				...
				<button
					...
					title="Hide sidebar"
				>
					<SidebarLeftOpenIcon width={16} height={16} />
				</button>
			</div>
				...
				>
					...
					>
						...
						<ChevronRightIcon
							width="12"
							height="12"
							style={{ color: "var(--dim)", flexShrink: 0, marginLeft: "auto" }}
						/>
					</button>
